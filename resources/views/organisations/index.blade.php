...
@push('js')
    ...
    {{-- Logique métier (ordre important) --}}
    ...
    <script src="{{ asset('js/organisations/show.js?v='.filemtime(public_path('js/organisations/show.js'))) }}"></script>
    <script src="{{ asset('js/organisations/filters.js?v='.filemtime(public_path('js/organisations/filters.js'))) }}"></script>
    <script src="{{ asset('js/organisations/select2.js?v='.filemtime(public_path('js/organisations/select2.js'))) }}"></script>
